    ...
    <div className="h-screen w-screen overflow-hidden bg-white text-[#1a1a1a] font-[var(--font-onest)]">
      ...
      <nav className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Preview Button */}
          <button onClick={() => router.push(`/preview/${courseKey}?from=editor`)} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
