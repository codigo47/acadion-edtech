                                    ...
                                    .map((comp, idx) => {
                                      ...
                                      return (
                                        <div key={idx}>
                                          ...
                                          {idx === 0 && (
                                            <div className="flex justify-center py-2 pl-10">
                                              <div className="relative group/tooltip">
                                                <button className="w-8 h-8 flex items-center justify-center rounded-md bg-[#9F80DA] hover:bg-[#8A6BC5] text-white transition-all shadow-sm">
                                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          ...
                                          <div className="flex items-stretch gap-2">
                                            ...
                                            {/* Component container */}
                                            <div className="flex-1 relative bg-white rounded-xl border-2 border-gray-200 hover:border-[#9F80DA] transition-colors">
                                              ...
                                              <div className="flex items-center justify-center px-2 py-2 border-b border-gray-100 relative">
                                                ...
                                                <div className="flex items-center gap-1">
                                                  ...
                                                  <div className="relative group/tooltip">
                                                    <button className="w-8 h-8 flex items-center justify-center rounded-md bg-[#9F80DA] hover:bg-red-500 text-white transition-all shadow-sm">
                                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
