          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              ...
              <p className="mb-4">
                ...
                the tool we wish we had?" That question sparked a journey that would change our lives forever.
              </p>
              <p className="mb-4">
              ...
              <p>
                Today, Acadion.ai LLC is used by instructional designers across the globe, from freelancers creating
                courses from their home offices to teams in Fortune 500 companies. But we haven't forgotten our roots.
                We're still that team of instructional designers at heart, constantly learning from our community and
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Designer-First</h3>
              <p className="text-gray-600">
                Every feature is built with instructional designers' workflows in mind, because we are you.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Learning Impact</h3>
              <p className="text-gray-600">
                We measure our success by the quality and effectiveness of learning experiences created on our platform.
              </p>
            </motion.div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We're always looking for talented individuals who share our passion for transforming education through technology.
          </p>
          <Link
            href="/careers"
