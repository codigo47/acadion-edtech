...
export default function AccessibilityCompliantFeature() {
  return (
    <div className="w-full h-full flex flex-col bg-white rounded-3xl overflow-hidden border-2 border-gray-200">
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-6 bg-white">
        ...
        <div className="space-y-2 md:space-y-3">
          ...
          {/* Selected placeholder with error bubble and Fix Accessibility Button */}
          <div className="relative p-2 md:p-3 bg-orange-50 border-2 border-orange-300 rounded-lg">
            <div className="h-3 md:h-4 bg-gray-200 rounded w-4/6"></div>

            {/* Error bubble */}
            <div className="absolute -top-8 md:-top-10 left-1/2 -translate-x-1/2 px-2 py-1 md:px-3 md:py-2 bg-orange-400 text-white text-[10px] md:text-xs rounded-lg font-medium shadow-lg whitespace-nowrap">
