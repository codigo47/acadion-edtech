...
export declare class PortfolioService {
    ...
    upsertPortfolio(userId: string, dto: UpdatePortfolioDto): Promise<({
        courses: ({
            course: {
                id: number;
                key: string;
    ...
    updateCourses(userId: string, dto: UpdatePortfolioCoursesDto): Promise<({
        courses: ({
            course: {
                id: number;
                key: string;
    ...
    sendContactMessage(username: string, dto: ContactPortfolioDto): Promise<{
        message: string;
        id: number;
        createdAt: Date;
        portfolioId: number;
