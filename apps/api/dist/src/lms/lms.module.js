...
exports.LmsModule = LmsModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, badge_module_1.BadgeModule, notification_module_1.NotificationModule],
        controllers: [lms_controller_1.LmsController],
        providers: [lms_service_1.LmsService, adaptive_service_1.AdaptiveService],
