...
"[project]/app/components/blocks/ZoomableImage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ZoomableImage({ src, alt = '', className = '', fill, width, height }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ZoomableImage.useEffect": ()=>{
            if (!isOpen) return;
            const handleKey = {
                "ZoomableImage.useEffect.handleKey": (e)=>{
                    if (e.key === 'Escape') setIsOpen(false);
                }
            }["ZoomableImage.useEffect.handleKey"];
            document.addEventListener('keydown', handleKey);
            return ({
                "ZoomableImage.useEffect": ()=>document.removeEventListener('keydown', handleKey)
            })["ZoomableImage.useEffect"];
        }
    }["ZoomableImage.useEffect"], [
        isOpen
...
_s(ZoomableImage, "vl0Rt3/A8evyRPW1OQ1AhRk4UhU=");
_c = ZoomableImage;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/image.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$blocks$2f$ZoomableImage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/blocks/ZoomableImage.tsx [app-client] (ecmascript)");
'use client';
;
;
;
function Image({ src, alt = 'Image', className = 'object-cover rounded-lg', fill = true, width, height, zoomable = false }) {
    ...
    if (zoomable) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$blocks$2f$ZoomableImage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            src: imageSrc,
            alt: alt,
            fill: fill,
            width: width,
...
function CarouselBlock({ images, zoomable = false, autoPlay = false, autoPlayInterval = 5, dark = false }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "CarouselBlock.useEffect": ()=>{
            if (!autoPlay || images.length <= 1) return;
            const timer = setInterval({
                "CarouselBlock.useEffect.timer": ()=>{
                    setCurrentIndex({
                        "CarouselBlock.useEffect.timer": (prev)=>prev === images.length - 1 ? 0 : prev + 1
                    }["CarouselBlock.useEffect.timer"]);
                }
            }["CarouselBlock.useEffect.timer"], autoPlayInterval * 1000);
            return ({
                "CarouselBlock.useEffect": ()=>clearInterval(timer)
            })["CarouselBlock.useEffect"];
        }
    }["CarouselBlock.useEffect"], [
        autoPlay,
...
_s(CarouselBlock, "tPjzCc9H5UuFdWNuAHYoD0K4UOk=");
_c = CarouselBlock;
var _c;
...
function AccordionBlock({ items = [], textStyle = {}, textBackgroundStyle = {}, blockStyle = 'A', allowMultiple = false, openFirst = true, dark = false }) {
    ...
    const [openItems, setOpenItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AccordionBlock.useState": ()=>openFirst && items.length > 0 ? [
                items[0].id
            ] : []
    }["AccordionBlock.useState"]);
...
_s(AccordionBlock, "QjuB+aR9a8aKR0eSHHIS+puKfsI=");
_c = AccordionBlock;
var _c;
...
function TabsBlock({ items = [], textStyle = {}, textBackgroundStyle = {}, openFirst = true, dark = false }) {
    _s();
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(openFirst ? items?.[0]?.id || '' : '');
    // Handle empty or missing items
    if (!items || items.length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `w-full p-4 rounded-lg ${dark ? 'bg-gray-900 text-gray-400' : 'bg-gray-100 text-gray-500'}`,
...
_s(TabsBlock, "k+KzGZ8t/Qa4Lm4oaxiFS61xQDQ=");
_c = TabsBlock;
var _c;
...
"[project]/app/components/blocks/BannerBlock.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = BannerBlock;
var _c;
__turbopack_context__.k.register(_c, "BannerBlock");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$blocks$2f$BannerBlock$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/blocks/BannerBlock.tsx [app-client] (ecmascript)");
;
;
;
;
...
"[project]/app/components/blocks/BannerBlock.tsx [app-client] (ecmascript) <export default as BannerBlock>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "BannerBlock",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$blocks$2f$BannerBlock$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$blocks$2f$BannerBlock$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/blocks/BannerBlock.tsx [app-client] (ecmascript)");
}),
...
"[project]/app/p/[username]/[courseKey]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(PortfolioCoursePage, "+jVsTcECDRo3yq2d7EQxlN9Ixog=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = PortfolioCoursePage;
var _c;
__turbopack_context__.k.register(_c, "PortfolioCoursePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f0935576._.js.map