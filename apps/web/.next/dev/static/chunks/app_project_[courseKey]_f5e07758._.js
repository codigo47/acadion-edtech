...
;
;
function EditorBlock({ component, componentId, componentDbId, groupKey, name, onDelete, onDuplicate, onPreview, onAIPrompt, onSwitchStyle, onDragStart, onDragOver, onDragEnd, onDrop, isDragOver, availableVariants }) {
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `relative bg-white rounded-xl border-2 transition-all ${isDragOver ? 'border-[#9F80DA] shadow-lg ring-2 ring-[#9F80DA]/20' : 'border-gray-200 hover:border-[#9F80DA]'}`,
        onDragOver: (e)=>onDragOver(e, componentId),
        onDrop: (e)=>onDrop(e, componentId),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center justify-between px-3 py-2 bg-gray-50 border-b border-gray-200 rounded-t-xl",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        draggable: true,
                        onDragStart: ()=>onDragStart(componentId),
                        onDragEnd: onDragEnd,
                        className: "cursor-grab active:cursor-grabbing p-1 rounded hover:bg-gray-200 transition-colors text-gray-400 hover:text-gray-600",
                            ...
                            hasVariants && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    showStyleDropdown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute top-full left-1/2 -translate-x-1/2 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50 min-w-[180px]",
                                        children: availableVariants.map((variant)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: `w-full flex items-center gap-2 px-3 py-2 text-sm transition-colors ${isActive ? 'bg-[#9F80DA]/10 text-[#9F80DA] font-medium' : 'text-gray-700 hover:bg-gray-50'}`,
                                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `flex items-center gap-1.5 px-2 py-1 rounded-md ${meta.color}`,
                        children: [
...
_s(EditorBlock, "DuCMostr4sWLKcECQnZnUWB7Y1w=");
_c = EditorBlock;
...
function EditorContent({ courseKey, proposedIndex, components, onSaveStatusChange }) {
        ...
        "EditorContent.useMemo[variantsMap]": ()=>{
            ...
            for (const comp of components){
                if (comp.groupKey && comp.componentId) {
                    // We need to collect all variants from the blockMetadata for this group
                    if (!map.has(comp.groupKey)) {
                        ...
                        // We'll build this from the components data since we need componentId
                        map.set(comp.groupKey, []);
                    }
                }
            }
            // Build unique variants by iterating over all components with groupKeys
            // and also including all known variants from metadata
            for (const comp of components){
                if (comp.groupKey && comp.componentId) {
    ...
    const handleAIGenerate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditorContent.useCallback[handleAIGenerate]": (_prompt)=>{
            ...
            // Show a brief "saved" status to give feedback
    ...
    const handleDragOver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditorContent.useCallback[handleDragOver]": (e, id)=>{
            e.preventDefault();
    ...
    const handleDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EditorContent.useCallback[handleDrop]": (e, targetId)=>{
            e.preventDefault();
            if (draggedId === null || draggedId === targetId) {
                handleDragEnd();
                return;
            }
            // Find the dragged and target components
            const draggedComp = components.find({
                "EditorContent.useCallback[handleDrop].draggedComp": (c)=>c.id === draggedId
            }["EditorContent.useCallback[handleDrop].draggedComp"]);
            const targetComp = components.find({
                "EditorContent.useCallback[handleDrop].targetComp": (c)=>c.id === targetId
            }["EditorContent.useCallback[handleDrop].targetComp"]);
            if (!draggedComp || !targetComp) {
                handleDragEnd();
                return;
            }
            // Only allow reorder within the same module+unit
            if (draggedComp.module !== targetComp.module || draggedComp.unit !== targetComp.unit) {
                handleDragEnd();
                return;
            }
            // Get all components in this unit, sorted by sequence
            const unitComps = components.filter({
                "EditorContent.useCallback[handleDrop].unitComps": (c)=>c.module === draggedComp.module && c.unit === draggedComp.unit
            }["EditorContent.useCallback[handleDrop].unitComps"]).sort({
                "EditorContent.useCallback[handleDrop].unitComps": (a, b)=>a.sequence - b.sequence
            }["EditorContent.useCallback[handleDrop].unitComps"]);
            // Remove dragged from list and insert at target position
            const withoutDragged = unitComps.filter({
                "EditorContent.useCallback[handleDrop].withoutDragged": (c)=>c.id !== draggedId
            }["EditorContent.useCallback[handleDrop].withoutDragged"]);
            const targetIndex = withoutDragged.findIndex({
                "EditorContent.useCallback[handleDrop].targetIndex": (c)=>c.id === targetId
            }["EditorContent.useCallback[handleDrop].targetIndex"]);
            withoutDragged.splice(targetIndex, 0, draggedComp);
            // Build new sequence order
            const reorderItems = withoutDragged.map({
                "EditorContent.useCallback[handleDrop].reorderItems": (c, idx)=>({
                        id: c.id,
                        sequence: idx + 1
                    })
            }["EditorContent.useCallback[handleDrop].reorderItems"]);
            updateSaveStatus('saving');
            reorderComponents.mutate({
                ...
                onSuccess: {
                    "EditorContent.useCallback[handleDrop]": ()=>updateSaveStatus('saved')
                }["EditorContent.useCallback[handleDrop]"],
                onError: {
                    "EditorContent.useCallback[handleDrop]": ()=>updateSaveStatus('error')
                }["EditorContent.useCallback[handleDrop]"]
            });
            handleDragEnd();
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CustomScrollbar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomScrollbar"], {
                children: components.length > 0 && proposedIndex ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        proposedIndex.modules.map((module)=>{
                            const moduleComponents = components.filter((c)=>c.module === module.number);
                            const unitNumbers = [
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    allUnits.map((unit)=>{
                                        const unitComponents = moduleComponents.filter((c)=>c.unit === unit.unitNum).sort((a, b)=>a.sequence - b.sequence);
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        className: "flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-[#9F80DA] bg-white border border-dashed border-gray-300 hover:border-[#9F80DA] rounded-lg transition-all",
                                                                        children: [
...
_s(EditorContent, "3b0A4/UwAFOVQRgEUSJdrg8batQ=", false, function() {
    return [
...
//# sourceMappingURL=app_project_%5BcourseKey%5D_f5e07758._.js.map