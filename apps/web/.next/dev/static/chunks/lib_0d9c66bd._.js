...
"[project]/lib/hooks/use-favorite-colors.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useFavoriteColors() {
    ...
    const addFavorite = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFavoriteColors.useCallback[addFavorite]": (color)=>{
            setFavorites({
                "useFavoriteColors.useCallback[addFavorite]": (prev)=>{
                    const normalized = color.toUpperCase();
                    if (prev.some({
                        "useFavoriteColors.useCallback[addFavorite]": (c)=>c.toUpperCase() === normalized
                    }["useFavoriteColors.useCallback[addFavorite]"])) return prev;
                    const next = [
                        color,
                        ...prev
            ...
            }["useFavoriteColors.useCallback[addFavorite]"]);
        }
    }["useFavoriteColors.useCallback[addFavorite]"], []);
    const removeFavorite = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFavoriteColors.useCallback[removeFavorite]": (color)=>{
            setFavorites({
                "useFavoriteColors.useCallback[removeFavorite]": (prev)=>{
                    const normalized = color.toUpperCase();
                    const next = prev.filter({
                        "useFavoriteColors.useCallback[removeFavorite].next": (c)=>c.toUpperCase() !== normalized
                    }["useFavoriteColors.useCallback[removeFavorite].next"]);
                    writeFavorites(next);
                    return next;
                }
            }["useFavoriteColors.useCallback[removeFavorite]"]);
        }
    }["useFavoriteColors.useCallback[removeFavorite]"], []);
    return {
        favorites,
...
_s(useFavoriteColors, "ILv2zj/jMLgJ+n88z+7PCQ+XCwg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s3(useReorderComponents, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
_s4(useSwitchComponentStyle, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
//# sourceMappingURL=lib_0d9c66bd._.js.map